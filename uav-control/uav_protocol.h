...
#define IDENT_VERSION   0x00000013  // uav_control protocal version
...
#define PKT_RCI_NUM         (PKT_BASE + 2)
#define PKT_RCI_LENGTH      (sizeof(uint32_t) * PKT_RCI_NUM)
...
#define PKT_VTI_NUM         (PKT_BASE + 8)
#define PKT_VTI_LENGTH      (sizeof(uint32_t) * PKT_VTI_NUM)
...
#define PKT_VCM_NUM         (PKT_BASE + 2)
#define PKT_VCM_LENGTH      (sizeof(uint32_t) * PKT_VCM_NUM)
...
#define PKT_MCM_AXIS_NUM    (PKT_BASE + 4)
#define PKT_MCM_LENGTH      (sizeof(uint32_t) * PKT_MCM_AXIS_NUM)
...
#define FCS_STATE_GROUNDED  0
#define FCS_STATE_REPLAY    1
#define FCS_STATE_TAKEOFF   2
#define FCS_STATE_HOVERING  3
#define FCS_STATE_LANDING   4
...
#define PKT_CAM_TC_NUM      (PKT_BASE + 10)
#define PKT_CAM_TC_LENGTH   (sizeof(uint32_t) * PKT_CAM_TC_NUM)
...
#define PKT_CAM_DCI_NUM     (PKT_BASE + 16)
#define PKT_CAM_DCI_LENGTH  (sizeof(uint32_t) * PKT_CAM_DCI_NUM)
...
#define PKT_CAM_DCM_NUM     (PKT_BASE + 11)
#define PKT_CAM_DCM_LENGTH  (sizeof(uint32_t) * PKT_CAM_DCM_NUM)
...
#define PKT_CAM_DCC_NUM     (PKT_BASE + 2)
#define PKT_CAM_DCC_LENGTH  (sizeof(uint32_t) * PKT_CAM_DCC_NUM)

// Set trim settings

#define PKT_STS_AXES        (PKT_BASE + 0)  // axis to set trim
#define PKT_STS_VALUE       (PKT_BASE + 1)  // trim value (signed integer)
#define PKT_STS_NUM         (PKT_BASE + 2)
#define PKT_STS_LENGTH      (sizeof(uint32_t) * PKT_STS_NUM)
...
#define PKT_GTS_NUM         (PKT_BASE + 4)
#define PKT_GTS_LENGTH      (sizeof(uint32_t) * PKT_GTS_NUM)
...
#define PKT_SFS_NUM         (PKT_BASE + 2)
#define PKT_SFS_LENGTH      (sizeof(uint32_t) * PKT_SFS_NUM)
...
#define PKT_GFS_NUM         (PKT_BASE + 4)
#define PKT_GFS_LENGTH      (sizeof(uint32_t) * PKT_GFS_NUM)
...
#define PKT_SPIDS_AXIS      (PKT_BASE + 2)
#define PKT_SPIDS_NUM       (PKT_BASE + 3)
#define PKT_SPIDS_LENGTH    (sizeof(uint32_t) * PKT_SPIDS_NUM)
...
#define PKT_GPIDS_SP        (PKT_BASE + 4)
#define PKT_GPIDS_NUM       (PKT_BASE + 5)
#define PKT_GPIDS_LENGTH    (sizeof(uint32_t) * PKT_GPIDS_NUM)
